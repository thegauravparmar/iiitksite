...
export default function Footer(params) {
	return <div>
        ...
        <h1 class="text-center pt-5">Why Join IIIT Kota?</h1>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12"><p>Academics here are completely industry oriented from the very start. The curriculum is revised after many
                                iterations from MHRD and we follow the same.</p></div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12"><p>IIIT Kota always focuses on learning by doing, whether it be in technological or in cultural fields. We have
                                well-furnished labs for practicing the same.</p></div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12"><p>MNIT Jaipur being the mentor institute of iiitkota, made a strong foundation both in terms of culture and
                                technology. With numerous facilities and countless opportunities from MNIT Jaipur, IIIT Kota was able to
                                stand out among its competitors and make a difference.</p></div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12"><p>IIIT Kota has always striven to provide equal opportunities for both genders in every aspect possible.
                                Meanwhile focusing on women's security by forming up a completely new cell just for women security (ICC).</p></div>
                        </div>
                    </div>
                </div>
            </div>
